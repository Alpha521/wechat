...
user_id = "okCU26Gxs7OSjbr9N12KwLmf2heg"
template_id = "JxVL2lw-roI1mESaYN4OlD8O0EAzvRnbfkLzCygWZ78"
...
def get_weather():
  ...
  return region, city, prov, date, text_now, temp_now, temp_min, temp_max, day_wea, night_wea, sunrise, sunset, moonrise, moonset
...
region,city,prov,data,text_now,temp_now,temp_min,temp_max,day_wea,night_wea,sunrise,sunset,moonrise,moonset = get_weather()
